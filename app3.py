...
def desc_calc():
    ...
    bashCommand = "java -Xms2G -Xmx2G -Djava.awt.headless=true -jar /Users/saniyaparab/Documents/aayushi/PaDEL-Descriptor/PaDEL-Descriptor.jar -removesalt -standardizenitro -fingerprints -descriptortypes ./PaDEL-Descriptor/descriptors.xml -dir ./ -file descriptors_output.csv"
